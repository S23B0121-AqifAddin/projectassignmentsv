...
with row1_col2:
    ...
    summary_text = "This pie chart summarizes the composition of student confidence, revealing the part-to-whole relationship of management levels. It provides a clear visual for problem statement regarding inadequate budgeting knowledge." 
    st.info(summary_text)
...
with tab1:
    ...
    with sub_col1:
        ...
        st.info(summary_text)
        fig2, ax2 = plt.title('Financial Confidence Score by Age', fontsize=14, fontweight='bold', pad=20 )
